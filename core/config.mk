...
ifneq ($(EUCLID_BUILD),)
include vendor/euclid/config/BoardConfigEuclid.mk
endif
...
ifneq ($(EUCLID_BUILD),)
ifneq ($(wildcard device/euclid/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/euclid/sepolicy/common/sepolicy.mk)
endif
endif
...
else ifneq ($(filter vendor/hertzify-priv/%,$(DEFAULT_SYSTEM_DEV_CERTIFICATE)),)
